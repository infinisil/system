...
let
  ...
  module = fetchTarball {
    url = "https://github.com/Infinisil/nixbot/archive/ded075e0472dd6dd83eb413fef373e13caf5aab3.tar.gz";
    sha256 = "07fq7p6g46wvp9ghhh5xmmkj0ymxvndgxvb8w6x209692crwzgwk";
  } + "/module.nix";
